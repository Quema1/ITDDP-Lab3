...
import org.example.fitnessClub.service.App;
import org.example.fitnessClub.service.Constants;

public class AppServer {

	public static void main(String[] args) throws InterruptedException, IOException, URISyntaxException {
        System.out.println("\"FitnessClub\" Example Application");
        ...
        System.out.println("Application started.\n"
                + "Try accessing " + getBaseURI(Constants.BASE_URI, Constants.PORT, Constants.APPLICATION_PATH, Constants.CLIENT_SERVICE_PATH) +" in the browser.");
        System.out.println("WADL URI: " + "http://localhost:8080/fitnessClub/rest/application.wadl?detail=true\n");
